...
- **LED controls** - Drives the badge WS2812 LEDs with off, all-on, rainbow, pulse, traveling dot, random, rear-on, front-on, reactive touch, and reactive button patterns. Color modes include custom RGB, rainbow, flame, and random, with speed and brightness controls.
