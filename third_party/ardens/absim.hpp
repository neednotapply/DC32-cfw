...
struct atmega32u4_t
{
    ...
    uint16_t embedded_timer0_fract_addr;
    uint16_t embedded_timer0_overflow_addr;
    uint32_t embedded_delay_hits;
    uint32_t embedded_delay_last_ms;
    uint64_t embedded_delay_ms_total;
