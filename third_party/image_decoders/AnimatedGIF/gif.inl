...
#endif
#if !defined(NO_SIMD) && (defined(__ARM_NEON) || defined(__ARM_NEON__) || defined(__arm64__) || defined(__aarch64__))
#include <arm_neon.h>
#define HAS_NEON
#endif 
            ...
            switch(p[iOffset++]) /* Block type */
            {
                case 0xf9: /* Graphic extension */
                    if (p[iOffset] == 4) // correct length
                    {
                        ...
                        if (pPage->iFrameDelay <= 1) // GIFs with a zero delay are commonly intended to run as fast animation.
                           pPage->iFrameDelay = 16;
