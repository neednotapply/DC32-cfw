...
#define open imageViewerGifOpen
#define read imageViewerGifRead
#define lseek imageViewerGifSeek
#define close imageViewerGifClose
#define malloc imageViewerAlloc
#define calloc imageViewerCalloc
#define realloc imageViewerRealloc
#define free imageViewerFree
...
gd_open_gif(const char *fname)
{
    ...
    if (gif->canvas && (bgcolor[0] || bgcolor[1] || bgcolor [2]))
