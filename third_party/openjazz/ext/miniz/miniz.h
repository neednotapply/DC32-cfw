...
// OpenJazz normally only needs zlib APIs. The DC32 first-run installer also
// reads the original shareware ZIP through miniz's callback interface.
#if !defined(DC32_OPENJAZZ) && !defined(MINIZ_NO_ARCHIVE_APIS)
