...
#ifdef DC32_OPENJAZZ
void Anim::setFrameStorage(Sprite** frameSprites, signed char* frameX,
	signed char* frameY, int frameCapacity) {
	sprites = frameSprites;
	xOffsets = frameX;
	yOffsets = frameY;
	capacity = frameCapacity > 255 ? 255 : (unsigned char)frameCapacity;
}
#endif
