...
static_assert(sizeof(WhiteInPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 white-in effect exceeds fixed slot");
static_assert(sizeof(FadeInPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 fade-in effect exceeds fixed slot");
static_assert(sizeof(WhiteOutPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 white-out effect exceeds fixed slot");
static_assert(sizeof(FadeOutPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 fade-out effect exceeds fixed slot");
static_assert(sizeof(FlashPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 flash effect exceeds fixed slot");
static_assert(sizeof(RotatePaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 rotate effect exceeds fixed slot");
static_assert(sizeof(SkyPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 sky effect exceeds fixed slot");
static_assert(sizeof(P2DPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 2D effect exceeds fixed slot");
static_assert(sizeof(P1DPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 1D effect exceeds fixed slot");
static_assert(sizeof(WaterPaletteEffect) <= DC32_OJ_PALETTE_SLOT_SIZE,
	"DC32 water effect exceeds fixed slot");

void* PaletteEffect::operator new (size_t size) {
	void* ptr = dc32OjPaletteEffectAlloc(size);
...
void PaletteEffect::operator delete (void* ptr) {
	dc32OjPaletteEffectFree(ptr);
}

void PaletteEffect::operator delete (void* ptr, size_t) {
	dc32OjPaletteEffectFree(ptr);
}
#endif
